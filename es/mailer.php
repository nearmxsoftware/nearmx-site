...
$secret = "6LclOkIaAAAAAO8zb4EvetMtWy6jEDVn7aQ1EJjK";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $recipient = "jon.palma@nearmx.com";

    // Set the email subject.
    $subject = "Contact to $name";

    // Build the email content.
    $email_content = "Mensaje enviado desde NEARMX<br><br>";
    $email_content .= "Name: $name<br><br>";
    $email_content .= "Phone: $phone<br><br>";
    $email_content .= "Email: $email<br><br>";
    $email_content .= "City: $city<br><br>";
    $email_content .= "Message:<br>$message<br><br>";



    // Build the email headers.
    $email_headers = "Content-Type: text/html; charset=UTF-8\n";
    $email_headers .= "To: $name <$email>";
    ...
    if (mail($recipient, $subject, $email_content, $email_headers)) {
        ...
        echo "Oops! A 500 error occurred, try again.";
    }

} else {
    // Not a POST request, set a 403 (forbidden) response code.
    http_response_code(403);
    echo "Oops! A 403 error occurred, try again.";
}
